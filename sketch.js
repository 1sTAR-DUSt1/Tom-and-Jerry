...
var cat, catImg1, catImg2, catImg3, mouse, mouseImg1, mouseImg2;
...
function preload() {
    ...
    mouseImg1 = loadAnimation("images/mouse1.png", "images/mouse2.png", "images/mouse3.png");
...
function draw() {
    ...
    if (cat.x-mouse.x < mouse.width/2+cat.width/2 &&
      ...
      console.log("Mouse.width = " + mouse.width)

      console.log("cat.x-mouse.x < mouse.width/2+cat.width/2 => " + (cat.x-mouse.x) + " < " + (mouse.width/2+cat.width/2));
      console.log("mouse.x-cat.x < mouse.width/2+cat.width/2 ==> " + (mouse.x-cat.x) + " < " + (mouse.width/2+cat.width/2));
      console.log("cat.y-mouse.y < mouse.height/2+cat.height/2 => " + (cat.y-mouse.y) + "<" + (mouse.height/2+cat.height/2));
      console.log("mouse.y-cat.y < mouse.height/2+cat.height/2) ==> " + (mouse.y-cat.y) + "<" + (mouse.height/2+cat.height/2));
